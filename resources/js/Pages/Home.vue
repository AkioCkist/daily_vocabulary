    ...
    <div class="max-w-2xl mx-auto px-4 py-8 relative z-10">
      ...
      <div class="mt-8 animate-slide-up">
        <button
          v-if="!added"
          @click="addWord"
          class="w-full bg-gradient-to-r from-green-500 via-emerald-500 to-emerald-600 text-white font-bold py-5 px-8 rounded-2xl shadow-depth-3 hover-lift btn-3d flex items-center justify-center gap-3 relative overflow-hidden group"
        >
        ...
        <!-- Success Message -->
        <div v-if="added" class="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200/50 rounded-2xl p-6 flex items-center gap-4 animate-bounce-in shadow-depth-2 dark:from-green-900/30 dark:to-emerald-900/30 dark:border-green-700/50 backdrop-blur-sm">
          <div class="w-12 h-12 bg-gradient-to-br from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center shadow-depth-2 animate-pulse-glow">
            <svg class="w-7 h-7 text-white drop-shadow-sm" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path>
            </svg>
          </div>
          <div>
            <p class="text-green-800 font-bold text-lg dark:text-green-400">Awesome! 🎉</p>
            <p class="text-green-700 dark:text-green-300 font-medium">Word added to your vocabulary</p>
          </div>
        </div>
      </div>
